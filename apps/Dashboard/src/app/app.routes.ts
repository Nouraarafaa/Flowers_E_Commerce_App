...
export const appRoutes: Route[] = [
    {
        path: "", loadComponent: () => import('./core/layout/main-layout/main-layout-component/mainLayout.component').then((c) => c.MainLayoutComponent), canActivate: [adminGuard], children: [
            ...
            { path: "products/update/:id", loadComponent: () => import('./features/products/components/update-product/update-product.component').then( (c)=> c.UpdateProductComponent ), title:"Update Product"},
